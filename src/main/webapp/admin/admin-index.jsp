...
<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
    <strong>中远方舟优惠券</strong> <small>后台管理</small>
  </div>
      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub " id="collapse-nav">
            <li><a href="rate.jsp" class="am-cf" target="subject"><span class="am-icon-check"></span> 倍率设置</a></li>
            <li><a href="notify.jsp" target="subject"><span class="am-icon-puzzle-piece"></span> 通知设置</a></li>
            <li><a href="betlimit.jsp" target="subject"><span class="am-icon-puzzle-piece"></span> 投注限制设置</a></li>
          </ul>
        </li>
        <li><a  class="am-cf am-collapsed" data-am-collapse="{target: '#collapse-nav2'}"><span class="am-icon-table"></span> 用户管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
            ...
            <li><a href="money.jsp" class="am-cf" target="subject"><span class="am-icon-check"></span> 用户金币管理</a></li>
            <li><a href="userlist.jsp" target="subject"><span class="am-icon-puzzle-piece"></span> 用户列表</a></li>
          </ul>
        </li>
        <li class="admin-parent">
