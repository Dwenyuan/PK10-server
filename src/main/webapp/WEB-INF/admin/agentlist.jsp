                ...
                <tbody>
                    <c:forEach varStatus="vs" items="${agentDatagrid.rows}" var="agent">
                        <tr>
                            ...
                            <td>${agent.tel}</td>
                            <td>${agent.detail}</td>
                            <td><fmt:formatDate value="${agent.createdAt}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            <td>
                                <div class="am-dropdown" data-am-dropdown>
                                    <button class="am-btn am-btn-default am-btn-xs am-dropdown-toggle" data-am-dropdown-toggle><span class="am-icon-cog"></span> <span class="am-icon-caret-down"></span></button>
                                    <ul class="am-dropdown-content">
                                        <li><a href="#" onclick="change(${agent.id},'${agent.username}','${agent.nickname}','${agent.password}','${agent.tel}','${agent.detail}')">1. 编辑</a></li>
            ...
            <div class="am-modal-dialog">
                ...
                <div class="am-modal-bd">
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-8 am-u-end">
                            <input type="text" class="am-input-sm" id="detail"></textarea>
                        </div>
                    </div>
                </div>
       ...
       function searchFor(){
           ...
           $.ajax({
               ...
               success: function(data) {
                   ...
                   document.getElementById('td5').innerHTML += detail;
