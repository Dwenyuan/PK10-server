...
<div class="am-cf am-padding am-padding-bottom-0">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户管理/帐变记录</strong> </div>
</div>
<hr>
<div class="am-g">
    <%--<c:choose>
                    ...
                    $(".tcdPageCode").createPage({
                        ...
                        backFn:function(p){
                            if (s_time > e_time) {
                                ...
                                location.href = "${pageContext.request.contextPath}/account-change/account-change-list"
                                        +"/null/null?pn=" + p;
