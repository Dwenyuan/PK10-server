    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a  class="am-cf am-collapsed" data-am-collapse="{target: '#collapse-nav2'}"><span class="am-icon-table"></span> 用户管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
            ...
            <li><a href="/userinfo/money-manager" class="am-cf" target="subject"><span class="am-icon-check"></span> 用户金币管理</a></li>
            <li><a href="/userinfo/users?pn=1" target="subject"><span class="am-icon-puzzle-piece"></span> 用户列表</a></li>
          </ul>
        </li>
        <li class="admin-parent">
